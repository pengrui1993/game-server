...
//                worker.interrupt();//if uncomment that line , next line is true
                if(Thread.interrupted()){//interrupted by other thread :false,
                    System.out.println("loop:interrupted");
                    //System.out.println("loop:query again:"+Thread.interrupted());//always false
                }
//                System.out.println("loop:is interrupted:"+worker.isInterrupted());//false if interrupted by other thread
